    ...
    internal static class SingletonExample
    {
        ...
        public class SingletonDatabase : IDatabase
        {
            ...
            private SingletonDatabase()
            {
                ...
                capitals = File
                    .ReadAllLines(Path.Combine(new FileInfo(typeof(IDatabase).Assembly.Location).DirectoryName,
                        "capitals.txt"))
                    .Batch(2)
                    .ToDictionary(
            ...
            public static readonly SingletonDatabase Instance = instance.Value;
        }
